...
<div class="navbar navbar-expand-lg bg-light navbar-light">
    <div class="container-fluid">
        <a href="{{ route('home') }}" class="navbar-brand">CaterServ</a>
...
<div class="about">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="about-img">
                <img src="{{asset('assets/frontend/img/about.jpg')}}" alt="Image">
            ...
            <div class="col-lg-5">
                ...
                <div class="feature-text">
                    <div class="feature-img">
                        <div class="row">
                            <div class="col-6">
                                <img src="{{asset('assets/frontend/img/feature-1.jpg')}}" alt="Image">
                            </div>
                            <div class="col-6">
                                <img src="{{asset('assets/frontend/img/feature-2.jpg')}}" alt="Image">
                            </div>
                            <div class="col-6">
                                <img src="{{asset('assets/frontend/img/feature-3.jpg')}}" alt="Image">
                            </div>
                            <div class="col-6">
                                <img src="{{asset('assets/frontend/img/feature-4.jpg')}}" alt="Image">
                            </div>
                        </div>
                    </div>
                    <p>
...
<div class="testimonial">
    <div class="container">
        <div class="owl-carousel testimonials-carousel">
            ...
            <div class="testimonial-item">
                <div class="testimonial-img">
                <img src="{{asset('assets/frontend/img/testimonial-2.jpg')}}" alt="Image">
                </div>
                <p>
                    Lorem ipsum dolor sit amet elit. Phasel nec preti mi. Curabit facilis ornare velit non vulput
                </p>
            ...
            <div class="testimonial-item">
                <div class="testimonial-img">
                <img src="{{asset('assets/frontend/img/testimonial-3.jpg')}}" alt="Image">
                </div>
                <p>
                    Lorem ipsum dolor sit amet elit. Phasel nec preti mi. Curabit facilis ornare velit non vulput
                </p>
            ...
            <div class="testimonial-item">
                <div class="testimonial-img">
                <img src="{{asset('assets/frontend/img/testimonial-4.jpg')}}" alt="Image">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="blog-item">
                    <div class="blog-img">
                        <img src="{{asset('assets/frontend/img/blog-1.jpg')}}" alt="Image">
                    </div>
            ...
            <div class="col-md-6">
                <div class="blog-item">
                    <div class="blog-img">
                        <img src="{{asset('assets/frontend/img/blog-2.jpg')}}" alt="Image">
...
<div class="footer">
    ...
    <div class="copyright">
        <div class="container">
            <p>Copyright &copy; <a href="#">{{$setting->website_title}}</a>, All Right Reserved.</p>
