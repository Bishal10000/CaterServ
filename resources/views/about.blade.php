    ...
    <div class="container">
        <div class="row g-5 align-items-center">
            <div class="col-lg-5 wow bounceInUp" data-wow-delay="0.1s">
                <img src="{{ asset('assets/frontend/img/about.jpg') }}" class="img-fluid rounded" alt="Team Member">
        ...
        <div class="row g-4">
            <div class="col-lg-3 col-md-6 wow bounceInUp" data-wow-delay="0.1s">
                <div class="team-item rounded">
                    <img src="{{ asset('assets/frontend/img/team-1.jpg') }}" class="img-fluid rounded-top" alt="">
            ...
            <div class="col-lg-3 col-md-6 wow bounceInUp" data-wow-delay="0.3s">
                <div class="team-item rounded">
                    <img src="{{ asset('assets/frontend/img/team-2.jpg') }}" class="img-fluid rounded-top" alt="">
                    <div class="team-content text-center py-3 bg-dark rounded-bottom">
            ...
            <div class="col-lg-3 col-md-6 wow bounceInUp" data-wow-delay="0.5s">
                <div class="team-item rounded">
                    <img src="{{ asset('assets/frontend/img/team-3.jpg') }}" class="img-fluid rounded-top" alt="">
                    <div class="team-content text-center py-3 bg-dark rounded-bottom">
            ...
            <div class="col-lg-3 col-md-6 wow bounceInUp" data-wow-delay="0.7s">
                <div class="team-item rounded">
                    <img src="{{ asset('assets/frontend/img/team-4.jpg') }}" class="img-fluid rounded-top" alt="">
                ...
                <div class="footer-item">
                    ...
                    <div class="row g-2">
                        <div class="col-4">
                            ...
                            <img src="{{ asset('assets/frontend/img/menu-01.jpg') }}" class="img-fluid rounded-circle border border-primary p-2" alt="">

                        </div>
                        <div class="col-4">
                            <img src="{{ asset('assets/frontend/img/menu-02.jpg') }}" class="img-fluid rounded-circle border border-primary p-2" alt="">
                        </div>
                        <div class="col-4">
                            <img src="{{ asset('assets/frontend/img/menu-03.jpg') }}" class="img-fluid rounded-circle border border-primary p-2" alt="">
                        </div>
                        <div class="col-4">
                            <img src="{{ asset('assets/frontend/img/menu-04.jpg') }}" class="img-fluid rounded-circle border border-primary p-2" alt="">
                        </div>
                        <div class="col-4">
                            <img src="{{ asset('assets/frontend/img/menu-05.jpg') }}" class="img-fluid rounded-circle border border-primary p-2" alt="">
                        </div>
                        <div class="col-4">
                            <img src="{{ asset('assets/frontend/img/menu-06.jpg') }}" class="img-fluid rounded-circle border border-primary p-2" alt="">
                        </div>
                    </div>
                </div>
            </div>
